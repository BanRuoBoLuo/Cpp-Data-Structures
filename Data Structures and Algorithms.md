...
- [C++ Data Structures and Algorithms Cheat Sheet](#c-data-structures-and-algorithms-cheat-sheet)
	...
	- [1.0 Data Structures](#10-data-structures)
		...
		- [1.3 Doubly-Linked List `std::list`](#13-doubly-linked-list-stdlist)
		- [1.4 Linked List `std::forward_list`](#14-linked-list-stdforward_list)
		...
		- [1.9 Deque `std::deque`](#19-Deque-stddeque)
		- [1.10 Priority Queue `std::priority_queue`](#110-priority-queue-stdpriority_queue)
	- [2.0 Trees](#20-trees)
